...
<head>
    ...
    <link href="/servlet/css/customer/layout.css" type="text/css" rel="stylesheet" />
    <style>
							...
							<tbody>
								...
								<tr>
									...
									<c:forTokens var="fileName" items="${n.files}" delims="," varStatus="st">
										...
										<a download href ="/servlet/member/upload/${fileName}" style="${style}">${fn:toUpperCase(fileName) }</a>
										<c:if test="${!st.last}">
										/
										</c:if>
									</c:forTokens>
