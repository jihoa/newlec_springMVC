                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-align-left text-indent text-strong text-orange" colspan="3">
										<select name="category">
											<!-- 서블릿 필터 한글 입력 잘되는지 테스트를 위해 벨류값 임시로 한글 넣기. -->
                                ...
                                <tr>
                                    ...
                                    <td class="text-align-left text-indent text-strong text-orange" colspan="3">
                                   		...
                                   		<input type="checkbox" name="foods" value="3" id="ch3"><label for="ch3">볶음면</label>
                                   		
                                   		<input type="checkbox" name="foods" value="4" id="ch4"><label for="ch4">냉면</label>
                                    </td>
                                </tr>
                                <tr>
                                    <th>첨부파일</th>
